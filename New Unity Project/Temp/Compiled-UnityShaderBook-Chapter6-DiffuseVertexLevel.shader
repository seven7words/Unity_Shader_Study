...
Constant Buffer "Globals" (256 bytes) on slot 0 {
  ...
  Vector4 glstate_lightmodel_ambient at 144
  Vector4 _LightColor0 at 224
  Vector4 _Diffuse at 240
}
    ...
    Mtl_VertexIn input [[ stage_in ]])
{
    ...
    output.COLOR0.xyz = fma(u_xlat1.xyz, u_xlat0.xxx, u_xlat2.xyz);
    return output;
}
...
void main()
{
    ...
    vs_COLOR0.xyz = u_xlat1.xyz * u_xlat0.xxx + u_xlat2.xyz;
    return;
}
